...
# Windows Object
class GetStartupDirectories : baseModule {
    $Name = "GetStartupDirectories"
    $BasePath = "Persistence"
    $Payload = "GetStartupDirectories.ps1"
...
# Add Module
$Global:Console.Modules.Add([GetStartupDirectories]::new())
...
function GetStartupDirectories {
    ...
    # E.G.  "GetStartupDirectories -ProcessID '$($ProcessID)'"
    # This will pass the named argument 'ProcessID' to the payload script
    $Call = "GetStartupDirectories" 
