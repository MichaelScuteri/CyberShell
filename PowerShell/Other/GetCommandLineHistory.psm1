...
# Windows Object
class GetCommandLineHistory : baseModule {
    $Name = "GetCommandLineHistory"
    $BasePath = "Other"
    $Payload = "GetCommandLineHistory.ps1"
...
# Add Module
$Global:Console.Modules.Add([GetCommandLineHistory]::new())
...
function GetCommandLineHistory {
    ...
    # E.G.  "GetCommandLineHistory -ProcessID '$($ProcessID)'"
    # This will pass the named argument 'ProcessID' to the payload script
    $Call = "GetCommandLineHistory" 
