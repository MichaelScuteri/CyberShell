...
# Windows Object
class GetBasicInformation : baseModule {
    $Name = "GetBasicInformation"
    $BasePath = "Basic"
    $Payload = "GetBasicInformation.ps1"
    $HelperDependencies = $null
    $ReflectiveDLLSDependencies = $null
    $Version = "1"
}
# Add Module
$Global:Console.Modules.Add([GetBasicInformation]::new())

# Function Prototype
function Get-BasicInformation {
    <#
    .SYNOPSIS
    ...
    # E.G.  "GetBasicinformation -ProcessID '$($ProcessID)'"
    # This will pass the named argument 'ProcessID' to the payload script
    $Call = "GetBasicInformation"
