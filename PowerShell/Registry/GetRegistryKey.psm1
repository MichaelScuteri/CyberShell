...
# Windows Object
class GetRegistryKey : baseModule {
    $Name = "GetRegistryKey"
    $BasePath = "Registry"
    $Payload = "GetRegistryKey.ps1"
...
# Add Module
$Global:Console.Modules.Add([GetRegistryKey]::new())
...
function GetRegistryKey {
    ...
    # E.G.  "GetRegistryKey -ProcessID '$($ProcessID)'"
    # This will pass the named argument 'ProcessID' to the payload script
    $Call = "GetRegistryKey -Path '$($Path)' -Hive '$($Hive)'" 
