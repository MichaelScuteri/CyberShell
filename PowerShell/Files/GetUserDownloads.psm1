...
# Windows Object
class GetUserDownloads : baseModule {
    $Name = "GetUserDownloads"
    $BasePath = "Files"
    $Payload = "GetUserDownloads.ps1"
...
# Add Module
$Global:Console.Modules.Add([GetUserDownloads]::new())
...
function GetUserDownloads {
    ...
    # E.G.  "GetUserDownloads -ProcessID '$($ProcessID)'"
    # This will pass the named argument 'ProcessID' to the payload script
    $Call = "GetUserDownloads -Hashtype '$($Hashtype)' -Maxsize '$($Maxsize)'"
